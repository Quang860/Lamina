...
testProxy(`https://api.codetabs.com/v1/proxy?quest=${encodeURIComponent(targetUrl)}`, 'CodeTabs');
testProxy(`https://thingproxy.freeboard.io/fetch/${targetUrl}`, 'ThingProxy');
